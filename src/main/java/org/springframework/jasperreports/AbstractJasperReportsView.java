...
public abstract class AbstractJasperReportsView extends AbstractUrlBasedView {
     ...
     */
    private Map<ExporterInput, Object> convertedExporterParameters;
     ...
     */
    protected void setConvertedExporterParameters(Map<ExporterInput, Object> parameters) {
     ...
     */
    protected Map<ExporterInput, Object> getConvertedExporterParameters() {
    ...
    protected final void convertExporterParameters() {
        if (!CollectionUtils.isEmpty(this.exporterParameters)) {
            this.convertedExporterParameters =
                    new HashMap<ExporterInput, Object>(this.exporterParameters.size());
            for (Map.Entry<?, ?> entry : this.exporterParameters.entrySet()) {
                ExporterInput exporterParameter = getExporterParameter(entry.getKey());
     ...
     */
    protected Object convertParameterValue(ExporterInput parameter, Object value) {
     ...
     */
    protected ExporterInput getExporterParameter(Object parameter) {
        if (parameter instanceof ExporterInput) {
            return (ExporterInput) parameter;
        }
     ...
     */
    protected ExporterInput convertToExporterParameter(String fqFieldName) {
        ...
        try {
            ...
            if (ExporterInput.class.isAssignableFrom(field.getType())) {
                try {
                    return (ExporterInput) field.get(null);
     ...
     * @see org.springframework.jasperreports.util.JasperReportsUtils#convertReportData
     * @see net.sf.jasperreports.engine.JRDataSource
