...
public class ConsejoPopular implements Serializable {
    ...
    @ManyToOne
    @JoinColumn(foreignKey = @ForeignKey(name = "fk_consejoPopular_municipio"))
    private Municipio municipio;
    
    /*@JsonIgnore
    @OneToMany(mappedBy = "consejoPopular")
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ConsejoPopular)) {
            return false;
        }
        ConsejoPopular other = (ConsejoPopular) object;
    ...
    public String toString() {
        return "entrega.clases.ConsejoPopular[ id=" + id + " ]";
    }
